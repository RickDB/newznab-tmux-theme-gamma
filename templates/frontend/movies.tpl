								...
								<ul class="inline">
									<li>
										<div class="icon icon_nzb">
											<a title="Download Nzb" href="{$smarty.const.WWW_TOP}/getnzb/{$mguid[$m@index]}/{$mname[$m@index]|escape:"url"}"><img src="{$smarty.const.WWW_TOP}/themes/gamma/images/icons/nzbup.png"></a>
										</div>
									</li>
									<li>

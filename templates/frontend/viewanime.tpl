				...
				<tr class="{cycle values=",alt"}" id="guid{$result.guid}">
					...
					<div class="resextra">
						<div class="btns">							
							...
							{/if}
					<td class="less"><a title="This anime in {$result.category_name}" href="{$smarty.const.WWW_TOP}/anime/{$result.anidbidb}?t={$result.categoryid}">{$result.category_name}</a></td>

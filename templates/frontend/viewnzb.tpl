...
{if $anidb && $release.anidbidb > 0 && $anidb.picture != ""}<img class="shadow img-polaroid pull-right" style="margin-right:50px; margin-top:80px;" src="{$smarty.const.WWW_TOP}/covers/anime/{$anidb.anidbidb}.jpg" width="180" alt="{$anidb.title|escape:"htmlall"}" />{/if}
...
{if $book && $book.cover == 1}<img class="shadow img-polaroid pull-right" style="margin-right:50px; margin-top:80px;" src="{$smarty.const.WWW_TOP}/covers/book/{$book.id}.jpg" width="160" alt="{$book.title|escape:"htmlall"}" />{/if}
	...
	<dl class="dl-horizontal" style="margin-right:300px;">
		...
		<dd style="margin-top:15px; margin-bottom:15px;" id="{$release.guid}">
			...
			<a id="guid{$release.guid}" class="icon icon_cartNZBinfo fa fa-cart-arrow-down" style="text-decoration: none; color: #5c5c5c;"  href="#" title="Add to Cart"></a>
			{if $sabintegrated}

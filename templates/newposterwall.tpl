						...
						<div
							...
							<div class="rating-pod" id="guid{$result.guid}">
								<div class="icons divlink col-lg-4">
									...
									<span class="btn btn-hover btn-default btn-sm icon_cart text-muted" title="Add to Cart"><i class="fa fa-shopping-cart"></i></span>
									{if isset($sabintegrated) && $sabintegrated !=""}
										<span class="btn btn-hover btn-default btn-sm icon_sab text-muted" title="Send to my Queue"><i class="fa fa-cloud-download"></i></span>
									{/if}
								</div>
							</div>
